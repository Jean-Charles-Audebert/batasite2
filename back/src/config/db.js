...
const seedMedia = async () => {
  ...
  await pool.query(`
    ...
    VALUES
      ...
      (3, 'image', 'BADAJOZ.JPG', 'image/jpeg'),
      (4, 'image', 'mimosa.jpg', 'image/jpeg'),
      (5, 'image', 'charivari.jpg', 'image/jpeg'),
      (6, 'image', 'carnaval_lr.jpg', 'image/jpeg'),
      (7, 'image', 'A_VENIR.gif', 'image/gif'),
      (8, 'image', 'A_VENIR.gif', 'image/gif'),
