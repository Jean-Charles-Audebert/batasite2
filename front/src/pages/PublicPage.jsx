      ...
      <div className="public-page">
        ...
        {sections.map((section) => {
          ...
          switch (section.type) {
            case "hero":
              return (
                <section key={key} className="section hero-section">
                  <div
            ...
            case "presentation":
              return (
                <>
                  <section key={key} className="section presentation-section">
